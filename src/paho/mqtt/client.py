...
class Client(object):
    ...
    * Use disconnect() to disconnect from the broker
    ...
    def tls_set_by_mem(self, ca_certs=None, certfile=None, keyfile=None, cert_reqs=None, tls_version=None, ciphers=None):
        """Configure network encryption and authentication options. Enables SSL/TLS support.
        ...
        # Configure context
        if certfile is not None:
            context.load_cert_chain_by_mem(certfile, keyfile)
